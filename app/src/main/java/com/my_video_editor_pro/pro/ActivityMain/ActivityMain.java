package com.my_video_editor_pro.pro.ActivityMain;
...
import com.my_video_editor_pro.pro.ActivityVideoMusicList.ActivityVideoMusicList;
...
public class ActivityMain extends AppCompatActivity {
 ...
 builder.forUnifiedNativeAd(new UnifiedNativeAd.OnUnifiedNativeAdLoadedListener() {
    ...
    public void videojoin(View view) {
        ...
        final Intent intent = new Intent(this, com.my_video_editor_pro.pro.ActivityVideoJoiner.ActivityVideoList.class);
        intent.setFlags(67108864);
        if (mInterstitialAd != null && mInterstitialAd.isLoaded()) {
            mInterstitialAd.show();
            mInterstitialAd.setAdListener(new AdListener() {
    ...
    public void videotoimg(View view) {
        ...
        final Intent intent = new Intent(this, com.my_video_editor_pro.pro.ActivityVideoGIF.ActivityVideoList.class);
        intent.setFlags(67108864);
        if (mInterstitialAd != null && mInterstitialAd.isLoaded()) {
            mInterstitialAd.show();
            mInterstitialAd.setAdListener(new AdListener() {
