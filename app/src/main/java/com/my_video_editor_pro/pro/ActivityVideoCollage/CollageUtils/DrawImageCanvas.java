package com.my_video_editor_pro.pro.ActivityVideoCollage.CollageUtils;
    ...
    public Bitmap drawCanvas() {
        ...
        for (int i3 = 0; i3 < CollageUtils.clgstickerviewsList.size(); i3++) {
            try {
                ...
                com.my_video_editor_pro.pro.ActivityVideoCollage.CollageBitmapUtils.CollageUtils.width = collageSingleFingerView.getImageWidth();
                ...
                if (bitmapDrawable.getBitmap() != null) {
                    try {
                        ...
                        Bitmap createScaledBitmap = Bitmap.createScaledBitmap(bitmap, com.my_video_editor_pro.pro.ActivityVideoCollage.CollageBitmapUtils.CollageUtils.width, imageHeight, true);
